...
- Track observedSignals: concrete dream signals already present, such as people, places, symbols, emotions, sensory details, or real-life context
- If the user has provided a dream, emotions, scene, at least one concrete signal, and some real-life or sleep context, prefer ready_to_analyze
...
- 维护 observedSignals：已经出现的具体梦境线索，例如人物、地点、意象、情绪、感官细节、现实生活关联
- 如果用户已经提供梦境、情绪、场景、至少一个具体线索，以及现实生活或睡眠前情境，优先 ready_to_analyze
